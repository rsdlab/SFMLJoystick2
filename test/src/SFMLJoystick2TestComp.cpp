...
/*!
 * @file SFMLJoystick2TestComp.cpp
...
{
  SFMLJoystick2TestInit(manager);
  SFMLJoystick2Init(manager);
  RTC::RtcBase* comp;

  // Create a component
  comp = manager->createComponent("SFMLJoystick2Test");
...
bool RunTest()
{
  ...
  comp = mamager.getComponent("SFMLJoystick2Test0");
  if (comp == nullptr)
  {
  ...
  SFMLJoystick2Test* testcomp = dynamic_cast<SFMLJoystick2Test*>(comp);
  if (testcomp == nullptr)
  {
    std::cerr << "Component get failed." << std::endl;
    return false;
