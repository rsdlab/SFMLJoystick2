...
#ifndef SFMLJOYSTICK2_TEST__H
#define SFMLJOYSTICK2_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  SFMLJoystick2Test(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~SFMLJoystick2Test() override;
 ...
 protected:
   ...
   * PovX, PovY.
   */
  RTC::InPort<RTC::TimedLongSeq> m_axisIn;
...
extern "C"
{
  DLL_EXPORT void SFMLJoystick2TestInit(RTC::Manager* manager);
};

#endif // SFMLJOYSTICK2_TEST_H
